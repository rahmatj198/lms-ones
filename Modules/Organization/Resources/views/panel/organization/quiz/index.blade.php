        ...
        <div class="row g-24">
            <div class="col-xl-4 col-sm-6">
                <div class="single-dashboard-card single-dashboard-card2 carts-bg-one h-calc d-flex align-items-center">
                    ...
                    <div class="cat-caption">
                        <p class="pera font-600">{{ ___('organization.Total Submission') }}</p>
                        <!-- Counter -->
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="single-dashboard-card single-dashboard-card2 carts-bg-four h-calc d-flex align-items-center">
                    ...
                    <div class="cat-caption">
                        <p class="pera text-16 font-600">{{ ___('organization.Total Passed') }}</p>
                        <!-- Counter -->
                        <div class="single-counter mb-15">
                            <p class="currency">
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="single-dashboard-card single-dashboard-card2 carts-bg-three h-calc d-flex align-items-center">
                    ...
                    <div class="cat-caption">
                        <p class="pera text-16 font-600">{{ ___('organization.Total Failed') }}</p>
                        <!-- Counter -->
                        <div class="single-counter mb-15">
                            <p class="currency">
            ...
            <div class="col-lg-12">
                <div class="activity-table">
                    <table class="table-responsive">
                        <thead>
                            <tr>
                                <th>{{ ___('organization.Courses Name') }}</th>
                                <th>{{ ___('organization.Submissions') }}</th>
                                <th>{{ ___('organization.Marks') }}</th>
                                <th>{{ ___('organization.Average Marks') }}</th>
                        ...
                        <tbody>
                            @forelse ($data['quizzes'] as $quiz)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('organization.quiz.submission', encryptFunction($quiz->id)) }}"
