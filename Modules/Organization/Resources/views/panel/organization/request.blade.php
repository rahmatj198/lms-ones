                                        ...
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    @endif
                                                    @if (hasPermission('organization_approve'))
                                                    <li>
                                                        <a class="dropdown-item status_update" href="javascript:void(0);"
                                                            data-text="{{ ___('common.Approve') }}" data-href="{{ route('organization.admin.approve', $organization->id) }}">
                                                    ...
                                                    @if (hasPermission('organization_suspend'))
                                                        <li>
                                                            <a class="dropdown-item status_update" href="javascript:void(0);"
                                                                data-text="{{ ___('common.Suspend') }}" data-href="{{ route('organization.admin.suspend', $organization->id) }}">
                                                                <span class="icon mr-12">
