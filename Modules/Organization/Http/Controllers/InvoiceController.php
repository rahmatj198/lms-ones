...
class InvoiceController extends Controller
{
    ...
    public function organizationView($enroll_id)
    {
        try {
            ...
            ])->loadView('organization::panel.organization.invoice.invoice', compact('data'));
            return $pdf->stream('invoice-'.$data['enroll']->id.time().'.pdf');
            return view('organization::panel.organization.invoice.invoice',compact('data'));
        } catch (\Throwable $th) {
