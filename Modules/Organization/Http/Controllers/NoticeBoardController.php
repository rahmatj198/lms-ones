...
class NoticeBoardController extends Controller
{
    ...
    public function create($course_id)
    {
        ...
        try {
            ...
            $data['url'] = route('organization.noticeboard.store', $course_id); // url
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            $data['url'] = route('organization.noticeboard.update', $id); // url
    ...
    public function ajaxNoticeBoard(Request $request, $id)
    {
        try {
            ...
            $html = view('organization::panel.organization.ajax.course.noticeboard', compact('data'))->render();
