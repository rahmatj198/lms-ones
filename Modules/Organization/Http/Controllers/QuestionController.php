...
class QuestionController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('organization::panel.organization.quiz.index', compact('data')); // view
        } catch (\Throwable $th) {
    ...
    public function submission($quiz_id)
    {
        try {
            ...
            return view('organization::panel.organization.quiz.submission', compact('data')); // view
        } catch (\Throwable $th) {
    ...
    public function create($lesson_id)
    {
        ...
        try {
            ...
            $data['url'] = route('organization.question.store', $lesson_id); // url
    ...
    public function edit($id)
    {
        try {
            ...
            $data['url'] = route('organization.question.update', $id); // url
