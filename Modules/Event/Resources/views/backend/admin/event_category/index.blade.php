                            ...
                            <div class="align-self-center d-flex gap-2">
                                ...
                                <div class="align-self-center">
                                    <a href="javascript:void(0);" role="button" class="btn-add"
                                        ...
                                        <span class="d-none d-xl-inline" onclick="mainModalOpen(`{{ route('event.category.create') }}`)">{{ ___('common.add') }}</span>
                                    </a>
                                </div>
                            </div>
                        @endif
                                                    ...
                                                    @if (hasPermission('blog_category_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="javascript:void(0);" onclick="mainModalOpen(`{{ route('event.category.edit', $category->id) }}`)"><span
                                                                    class="icon mr-12"><i
                                                    ...
                                                    @if (hasPermission('blog_category_delete'))
                                                        <li>
                                                            <a class="dropdown-item delete_data" href="javascript:void(0);"
                                                                data-href="{{ route('event.category.destroy', $category->id) }}">
