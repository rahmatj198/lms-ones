                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-xl-12 mb-3">
                                    <label for="name" class="form-label ">{{ ___('event.Organizer Name') }}
                                        <span class="fillable">*</span>
                                    </label>
                                    <input type="text" class="form-control ot-input " name="name" id="name" value="{{ $data['organizer']->name }}">
                                </div>
                                <div class="col-xl-12 mb-3">
                                    <label for="email" class="form-label ">{{ ___('event.Email') }}
                                        <span class="fillable">*</span>
                                    </label>
                                    <input type="text" class="form-control ot-input" name="email" id="email" value="{{ $data['organizer']->email }}">
                                </div>
                                <div class="col-xl-12 mb-3">
                                    <label for="phone" class="form-label ">{{ ___('event.Phone') }}
                                        <span class="fillable">*</span>
                                    </label>
                                    <input type="text" class="form-control ot-input" name="phone" id="phone" value="{{ $data['organizer']->phone }}">
                                </div>
                                <div class="col-xl-12 mb-3">
