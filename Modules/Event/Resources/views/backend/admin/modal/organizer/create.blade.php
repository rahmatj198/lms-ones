                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-xl-12 mb-3">
                                    ...
                                    <input type="text" class="form-control ot-input" name="name" id="name" value="{{ old('name') }}">
                                </div>
                                <div class="col-xl-12 mb-3">
                                    <label for="email" class="form-label ">{{ ___('event.Email') }}
                                        <span class="fillable">*</span>
                                    </label>
                                    <input type="text" class="form-control ot-input" name="email" id="email" value="{{ old('email') }}">
                                </div>
                                <div class="col-xl-12 mb-3">
                                    <label for="phone" class="form-label ">{{ ___('event.Phone') }}
                                        <span class="fillable">*</span>
                                    </label>
                                    <input type="text" class="form-control ot-input" name="phone" id="phone" value="{{ old('phone') }}">
                                </div>
                                <div class="col-xl-12 mb-3">
