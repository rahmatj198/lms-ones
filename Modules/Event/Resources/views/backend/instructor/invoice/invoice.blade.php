    ...
    <div style="margin-left:auto;margin-right:auto;">
                ...
                <table>
                    <tr>
                        <td class="text-right small">
                            <span class=" strong">#{{ $data['event_registration']->invoice_number }}</span>
                            <br>
                            <span class=" strong">{{ date('d-m-Y', strtotime($data['event_registration']->created_at)) }}</span>
                        </td>
                    </tr>
                </table>
        ...
        <div style="width:100%;margin: auto;">
            <table class="padding text-left small border-bottom table-bordered">
                <thead>
                    <tr class="tr">
                        <th width="35%">{{ ___('event.Event Title') }}</th>
                ...
                <tbody class="strong">
                    <tr style="border: 2px solid #000;">
                        <td>{{ $data['event_registration']->event->title }} </td>
                        <td class="text-center">{{ showPrice(@$data['event_registration']->price) }}</td>
