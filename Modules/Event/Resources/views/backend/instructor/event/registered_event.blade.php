                        ...
                        <form action="" class="search-box-style">
                            <div class="responsive-search-box">
                                <input class="ot-search " type="text" name="search"
                                    placeholder="{{ ___('placeholder.Search Events') }}" value="{{ @$_GET['search'] }}">
                                <!-- icon -->
                ...
                <div class="col">
                    <div class="my-single-courses white-bg position-relative radius-8 h-calc">
                        <span class="course-badge position-absolute text-10 font-400 radius-4 "
                            >{{ @$event_registration->event->event_type }}</span>
                            ...
                            <div class="course-edit">
                                <div class="activity-dropdown">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" onclick="mainModalOpen(`{{ route('instructor.event.registered.details.view', encryptFunction($event_registration->id)) }}`)"
                                                class="action-primary"><i title="Details" class="ri-file-list-line"></i></a>
                                        </li>
                                        <li class="mb-2">
                                            <a href="{{ route('event.instructor.invoice.view', encryptFunction($event_registration->id)) }}"
