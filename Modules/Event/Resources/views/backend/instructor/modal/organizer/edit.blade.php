                ...
                <div class="custom-modal-body ">
                    <form action="{{ @$data['url'] }}" method="post" id="modal_values" enctype="multipart/form-data">
                        ...
                        <div class="ot-contact-form mb-24">
                            <label for="name" class="ot-contact-label">{{ ___('event.Organizer Name') }}
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="ot-contact-input" id="name" name="name" value="{{ @$data['organizer']->name }}" />
                        </div>
                        <div class="ot-contact-form mb-24">
                            <label for="email" class="ot-contact-label">{{ ___('event.Email') }}
                                <span class="text-danger">*</span>
                            </label>
                            <input type="email" class="ot-contact-input" id="email" name="email" value="{{ @$data['organizer']->email }}" />
                        </div>
                        <div class="ot-contact-form mb-24">
                            <label for="phone" class="ot-contact-label">{{ ___('event.Phone') }}
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="ot-contact-input" id="phone" name="phone" value="{{ @$data['organizer']->phone }}" />
                        </div>
                        <div class="ot-contact-form mb-24">
                        ...
                        <div class="ot-contact-form mb-24 ">
                            ...
                            <select class="ot-contact modal_select2" required id="status_id" name="status_id">
                                <option value="1" {{ @$data['organizer']->status_id === 1 ? 'selected':'' }}>{{ ___('common.Active') }}</option>
                                <option value="2" {{ @$data['organizer']->status_id === 2 ? 'selected':'' }}>{{ ___('common.Inactive') }}</option>
                            </select>
                        </div>
