                ...
                <div class="custom-modal-body ">
                    <form action="{{ @$data['url'] }}" method="post" id="modal_values" enctype="multipart/form-data">
                        ...
                        <div class="ot-contact-form mb-24">
                            ...
                            <input type="text" class="ot-contact-input" id="name" name="name" value="{{ @$data['speaker']->name }}" />
                        </div>
                        <div class="ot-contact-form mb-24">
                            <label for="designation" class="ot-contact-label">{{ ___('event.Designation') }}
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="ot-contact-input" id="designation" name="designation" value="{{ @$data['speaker']->designation }}" />
                        </div>
                        <div class="ot-contact-form mb-24">
