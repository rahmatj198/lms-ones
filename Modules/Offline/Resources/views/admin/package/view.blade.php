                ...
                <form action="{{ @$data['url'] }}" method="POST">
                    ...
                    <div class="row mb-3 d-flex justify-content-center">
                        <div class="col-xl-12 col-md-6 mb-3">
                            <label for="status_id" class="form-label">{{ ___('common.Package Name') }}</label>
                            <span>
                                <h5 class="text-15">{{ @$data['package']->package->name }}</h5>
                            </span>
                        </div>
                        <div class="col-xl-12 col-md-6 mb-3">
                            <label for="status_id" class="form-label">{{ ___('common.Invoice No') }}</label>
                            <span>
                                <h5 class="text-15">{{ @$data['package']->invoice_number }}</h5>
                            </span>
                        </div>
                        <div class="col-xl-12 col-md-6 mb-3">
                            <label for="status_id" class="form-label">{{ ___('common.Payment Method') }}</label>
                            <span>
                                <h5 class="text-15">{{ @$data['package']->payment_method }}</h5>
                            </span>
                        </div>
                        <div class="col-xl-12 col-md-6 mb-3">
                            <label for="status_id" class="form-label">{{ ___('offline.Payment Type') }}</label>
                            <span>
                                <h5 class="text-15">{{ @$data['package']->payment_manual['payment_type'] }}</h5>
                            </span>
                        </div>
                        <div class="col-xl-12 col-md-6 mb-3">
                            <label for="status_id" class="form-label">{{ ___('offline.Additional_Details') }}</label>
                            <span>
                                <h5 class="text-15">{{ @$data['package']->payment_manual['additional_details'] }}</h5>
                            </span>
                        </div>
                    </div>
                    <div class="row">
